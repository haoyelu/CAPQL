...
class QENV_CTN(object):
    ...
    def update_parameters(self, memory, batch_size, updates, delta = 0.1):
        ...
        with torch.no_grad():
            ...
            # Apply H operator to update Q functions 
            min_qf_next_target_2 = self.critic_target(next_state_batch, next_state_action, w_batch, h_op=True)
            min_qf_next_target = delta * min_qf_next_target_2 + (1-delta) * min_qf_next_target
